...
with server.auth.sign_in(tableau_auth):
    ...
    for datasource in datasources:
        if datasource.name == datasource_to_download:
    ...
    if os.path.exists("SingularDataSwapBackup/"):
        pass
    else:
        copy_dir("DownloadedFiles/", "SingularDataSwapBackup/")
